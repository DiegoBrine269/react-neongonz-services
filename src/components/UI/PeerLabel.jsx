...
export default function PeerLabel({checked, value, onChange, label, tooltip=false}) {
    return (
        <label className="relative inline-flex items-center text-xs mt-0 group">
            <input
                type="checkbox"
                ...
                onChange={onChange}
            />
            <span className="checkbox-label peer-checked:bg-blue-500 peer-checked:text-white peer-checked:ring-blue-500 relative z-2">
                {label}
            </span>
